...
export default async function Dashboard() {
    ...
    return (
        <div className="relative min-h-screen bg-[#F8FAFC] dark:bg-[#09090B]">
            ...
            <div className="fixed bottom-10 right-10 z-[500] group animate-in slide-in-from-bottom-20 duration-1000">
                <div className="flex flex-col items-end gap-6 relative">
                    ...
                    <div className="mb-2 transition-all group-hover:-translate-y-4 duration-500 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.3)] rounded-[2.5rem]">
                        <div className="relative bg-white/40 dark:bg-[#09090B]/60 border border-white/20 dark:border-white/10 backdrop-blur-3xl p-8 rounded-[2.5rem] max-w-[340px] transform transition-transform group-hover:scale-[1.02]">
                            ...
                            <p className="text-base font-black italic text-zinc-900 dark:text-zinc-50 leading-relaxed tracking-tight mb-8">
                                "{assistantMessage}"
                            </p>
                            {assistantActionLink && (
                    ...
                    {/* The Pulse Button */}
                    <button className="relative bg-[#0066FF] p-6 rounded-[2.2rem] shadow-[0_20px_40px_-10px_rgba(0,102,255,0.6)] text-white hover:bg-[#0052CC] hover:-rotate-6 transition-all active:scale-95 group/mainbtn">
                        <div className="absolute inset-0 rounded-[2.2rem] bg-[#0066FF] animate-ping opacity-20 pointer-events-none group-hover:animate-none" />
